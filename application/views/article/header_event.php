...
<head>
    ...
    <title>R17 Event - <?= $article->title_id; ?></title>
    ...
    <meta property="article:published_time" content="<?= date('Y-m-d H:i:s', $article->publish_date); ?>" />
    ...
    <meta property="og:image" content="<?= base_url('assets/img/event/' . $article->header_image); ?>" />
    <meta property="og:image:secure_url" content="<?= base_url('assets/img/event/' . $article->header_image); ?>" />
    ...
    <meta name="twitter:image" content="<?= base_url('assets/img/event/' . $article->header_image); ?>" />
